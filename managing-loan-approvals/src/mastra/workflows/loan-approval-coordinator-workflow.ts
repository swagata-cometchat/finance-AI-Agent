...
const coordinateLoanApprovalRequest = createStep({
  id: 'coordinate-loan-approval-request',
...
export const loanApprovalCoordinatorWorkflow = createWorkflow({
  id: 'loan-approval-coordinator-workflow',
  inputSchema: z.object({
  ...
  .then(coordinateLoanApprovalRequest)
  .commit();